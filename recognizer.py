...
class DollarRecognizer:
    def __init__(self):
        ...
        # (and then formatted the code inside VSCode to follow Python conventions, that's why this part is written in so many lines)
